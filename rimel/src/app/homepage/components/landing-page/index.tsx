 ...
 return (
     <div className="flex h-screen mt-15 ml-30">
       ...
       <div className="flex-1 p-4">
         <div className={`${poppins.className} w-892px h-344px bg-black text-white p-6 flex items-center justify-between`}>
           <div>
            
            <FaApple className=" pr-28 w-40 h-15"/>
             <p className="text-4xl font-bold">Up to 10% <br />off Voucher</p>
               ...
               {pictures.map((_, index) => (
                 <span
                   ...
                   className={`w-2 h-2 rounded-full cursor-pointer ${
                     selectedIndex === index ? "bg-red-500" : "bg-gray-400"
                   }`}
                   role="button"
                   tabIndex={0}
